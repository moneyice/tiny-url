...
public class SnowflakeSequence {
    ...
    public synchronized void setWorkerId(long workerId) {
        if (workerId > maxWorkerId) {
            throw new RuntimeException("[SnowflakeSequence-setWorkerId] workerId 不能大于31.");
        }
    ...
    public synchronized void setDatacenterId(long datacenterId) {
        if (datacenterId > maxDatacenterId) {
            throw new RuntimeException("[SnowflakeSequence-setDatacenterId] datacenterId 不能大于31.");
        }
